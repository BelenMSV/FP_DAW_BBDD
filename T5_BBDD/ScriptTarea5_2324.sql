...
DROP DATABASE IF EXISTS CESTASOLIDARIAT5;

CREATE DATABASE IF NOT EXISTS CESTASOLIDARIAT5;

USE CESTASOLIDARIAT5;
...
Insert into SOCIOS values('88544692S', 'Martirio', 'Batalla Salom','Calle Bilbao 2','666458123','1957-01-31',100,3,'1',253486);
...
Insert into SOCIOS values('33123987C', 'David', 'Pardo Marquez', 'Calle San Miguel 31','654004221','1993-01-04',2000,4,'3',NULL);
